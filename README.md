...
This version supersedes branch cg_param_m3/martini3_v2 in this repository. It implements DASH for bead partial charge calculations (https://github.com/rinikerlab/DASH-tree#), and as such requires additional python dependicies compared to previous branches.
...
To enable DASH, it must be installed as per their github (https://github.com/rinikerlab/DASH-tree#). DASH must be installed, and developer mode activated within the cg_param conda environemnt. Then it can be activated on the commandline using the "-q" flag.
